(function (factory) {
  ...
  const katexJSURL = 'third-party/katex.min.js';
  const katexCSSTag = '<link rel="stylesheet" href="third-party/katex.min.css" crossorigin="anonymous">';
  ...
  const polyfills = [
    {
      ...
      url: 'third-party/webcomponents-lite.js'
    }, {
      ...
      url: 'third-party/intersection-observer.js'
    },
  ];
